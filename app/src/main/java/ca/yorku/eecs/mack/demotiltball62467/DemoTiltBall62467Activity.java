...
/**
 * Demo_Tilt_Ball - with modifications by...
 *
 * Login ID - skirill
 * Student ID - 217862467
 * Last Name - Shpurov
 * First name(s) - Kirill
 */
public class DemoTiltBall62467Activity extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        cntxofParent=DemoTiltBall62467Activity.this;
        ...
        rb.configure(pathType, pathWidth, gain, orderOfControl, lapCount);
